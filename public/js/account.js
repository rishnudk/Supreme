...
//             try {
//                 const response = await fetch(`/user/orders/details/${orderId}`);
...
//                 // Shipping details
//                 document.getElementById("modalFullName").textContent = order.shippingAddress.fullName;
//                 document.getElementById("modalPhone").textContent = order.shippingAddress.phone;
...
//                     li.innerHTML = `
//                         <img src="${product.image}" alt="${product.name}" class="img-thumbnail me-3" style="width: 80px; height: 80px;">
//                         <div>
//                             <p><strong>${product.name}</strong></p>
//                             <p>Price: ₹${product.price} | Qty: ${product.quantity}</p>
...
//                 // Set order status
//                 document.getElementById("modalOrderStatus").value = order.orderStatus || "Pending";
